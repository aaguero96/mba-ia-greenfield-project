...
import { MockedService } from '../test/mock-types';
...
describe('AuthService — register', () => {
  ...
  let usersService: MockedService<UsersService>;
  let mailService: MockedService<MailService>;
  let verificationTokenRepository: MockedService<Repository<VerificationToken>>;
...
describe('AuthService — login', () => {
  let authService: AuthService;
  let usersService: MockedService<UsersService>;
  let refreshTokenRepository: MockedService<Repository<RefreshToken>>;
